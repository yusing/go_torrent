...
go build -o build/android/arm64-v8a/libtorrent_go.so -buildmode=c-shared -ldflags="-s -w"
@REM xcopy %NDK%\sources\cxx-stl\llvm-libc++\libs\arm64-v8a\libc++_shared.so build\android\arm64-v8a\ /Q /Y
...
go build -o build/android/armeabi-v7a/libtorrent_go.so -buildmode=c-shared -ldflags="-s -w"
@REM xcopy %NDK%\sources\cxx-stl\llvm-libc++\libs\armeabi-v7a\libc++_shared.so build\android\armeabi-v7a\ /Q /Y
...
go build -o build/android/x86/libtorrent_go.so -buildmode=c-shared -ldflags="-s -w"
@REM xcopy %NDK%\sources\cxx-stl\llvm-libc++\libs\x86\libc++_shared.so build\android\x86\ /Q /Y
...
go build -o build/android/x86_64/libtorrent_go.so -buildmode=c-shared -ldflags="-s -w"
@REM xcopy %NDK%\sources\cxx-stl\llvm-libc++\libs\x86_64\libc++_shared.so build\android\x86_64\ /Q /Y
